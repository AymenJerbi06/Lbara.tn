...
const { register, login, logout, me, updateProfile, requestPasswordChange, confirmPasswordChange, forgotPassword, resetPassword } = require('../controllers/authController');
